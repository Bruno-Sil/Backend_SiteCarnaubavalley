...
<div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="enderecos.php" class="list-group-item list-group-item-action bg-dark text-primary">Endereços</a>
                ...
                <div class="col-md-11" style="background-color: white">
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-9 d-flex justify-content-end ml-5">
                            <form method="post" action="../backend/acoes/cadastrar_endereco.php">
                                <div class="form-row">
                                    <div class="col-md-12">
                                        <label>CEP</label>
                                        <input value="<?php echo $start->getCep()?>" type="text" name="cep" class="form-control">
                                    </div>

                                    <div class="col-md-12">
                                        <label>Numero(Opcional)</label>
                                        <input value="<?php echo $start->getNumero()?>" type="text" name="numero" class="form-control" placeholder="Associação Brasileira...">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Logradouro</label>
                                        <input type="text" value="<?php echo $start->getLogradouro()?>" name="log" class="form-control" placeholder="81.309">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Complemento(Opcional)</label>
                                        <input value="<?php echo $start->getComplemento()?>" type="text" name="complemento" class="form-control" placeholder="email@exemplo.com">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Bairro</label>
                                        <input type="text" value="<?php echo $start->getBairro()?>" name="bairro" class="form-control" placeholder="email@exemplo.com">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Estado / UF</label>
                                        <input type="text" value="<?php echo $start->getEstado()?>" name="estado" class="form-control" placeholder="email@exemplo.com">
                                    </div>
<!--                                    Nao tem campo cidade na tabela-->
<!--                                    <div class="col-md-12">-->
<!--                                        <label>Cidade</label>-->
<!--                                        <input type="email" name="cidade" class="form-control" placeholder="email@exemplo.com">-->
<!--                                    </div>-->
                                </div>
