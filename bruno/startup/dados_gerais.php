  ...
  <body>
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="dados_gerais.php" class="list-group-item list-group-item-action bg-dark text-primary">Dados Gerais</a>
        ...
        <div class="row d-flex justify-content-center mt-5">
          <div class="col-md-11" style="background-color: white">
            ...
            <div id="qr">
              ...
              <h6>Dados Basicos da sua startup</h6>
            </div>
            ...
            <div class="row d-flex justify-content-center">
                  <div class="col-md-9 d-flex justify-content-end ml-5">
                    <form method="post" action="../backend/acoes/cadastrar_dados_gerais.php">
                      <div class="form-row">
                        <div class="col-md-12">
                          <label>Nome</label>
                          <input value="<?php echo $start->getNome()?>" type="text" name="nome" class="form-control">
                        </div>

                        <div class="col-md-12">
                          <label>Razão Social:(opcional)</label>
                          <input type="text" value="<?php echo $start->getRazaoSocial()?>" name="razao" class="form-control" placeholder="Associação Brasileira...">
                        </div>
                        <div class="col-md-12">
                          <label>CNPJ(opcional)</label>
                          <input type="text" value="<?php echo $start->getCnpj()?>" name="cnpj" class="form-control" placeholder="81.309">
                        </div>
                        <div class="col-md-12">
                          <label>Email</label>
                          <input type="email" value="<?php echo $start->getEmail()?>" name="email" class="form-control" placeholder="email@exemplo.com">
                        </div>
                        </div>
                        <div class="form-row">
                          <div class="col-md-5">
                            <label>Data da fundação</label>
                          <input type="date" name="dia" value="<?php echo $start->getDataFundacao()?>" class="form-control">
                          </div>
                        </div>
                        ...
                        <div class="form-row">
                          <div class="col-md-5">
                            <label>Telefone(opcional)</label>
                              <input type="text" value="<?php echo $start->getTelefone()?>" name="telefone" class="form-control" placeholder=" 999-999">
                          </div>
                        </div>
